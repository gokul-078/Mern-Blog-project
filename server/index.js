...
app.use(cors({credentials: true, origin: ["http://localhost:3000", "https://mern-blog-server-6n0r.onrender.com", "https://mern-blog-project-xi.vercel.app", "http://localhost:5000/api", "http://localhost:5000"]}))
